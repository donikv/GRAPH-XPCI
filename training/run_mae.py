...
def main(ds, in_channels, latent_dim, size, patch_size, output_dir):
    ...
    if model_args.config_name:
        ...
        config = ViTMAEConfig(in_channels, latent_dim, size, patch_size)
    ...
    if model_args.image_processor_name:
        ...
        image_processor = ViTImageProcessor(do_resize=False, do_rescale=False, do_normalize=False)
