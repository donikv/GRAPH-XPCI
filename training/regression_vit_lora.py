...
sys.path.append(os.path.join(os.getcwd(), 'submodules/lora_vit'))
...
def main():
    ...
    parser.add_argument('--lora_alpha', type=int, default=4, help='LoRA alpha (default: 4)')
    ...
    if args.record_path is not None:
        ...
        model = lora.LoRA_ViT_timm(vit_model=model, r=args.lora_rank, alpha=args.lora_alpha, num_classes=args.num_classes)
